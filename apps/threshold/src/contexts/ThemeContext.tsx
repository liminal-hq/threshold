...
export const ThemeContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
    ...
    const [useMaterialYou, setUseMaterialYouState] = useState<boolean>(SettingsService.getUseMaterialYou());
    const [materialYouResponse, setMaterialYouResponse] = useState<MaterialYouResponse | undefined>(undefined);
        ...
        const fetchColours = async () => {
            if (PlatformUtils.isMobile() && PlatformUtils.getPlatform() === 'android') {
                try {
                    ...
                    const response = await invoke<MaterialYouResponse>('plugin:theme-utils|get_material_you_colours');
