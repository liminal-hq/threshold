...
# Usage: backup-gemini
alias backup-gemini='tar -cv -I "gzip -9" -f /workspaces/threshold/gemini-backup.tar.gz -C /home/vscode .gemini'

# Alias to restore the .gemini folder from the current workspace
# Usage: restore-gemini
alias restore-gemini='tar -xzvf /workspaces/threshold/gemini-backup.tar.gz -C /home/vscode'
